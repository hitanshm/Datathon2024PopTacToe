...
october_data['Month'] = pd.to_datetime(october_data['Sent Date']).dt.to_period('M')
october_data['Parent Menu Selection'] = october_data['Parent Menu Selection'].fillna('Other')
